...
void loadObjects() {
	...
	particleFire = new FireParticleSystem(camera, fireShader, firePosition1);
}
void initialize()
{
	cout << "Init ..." << endl;
...
{
	//cout << "////////////////////////////TEST////////////////////////////" << endl;
	//FireParticle * container = new FireParticle[50];
	//cout << "container[2].isAlive(): "<< container[2].isAlive() << endl;
	//cout << "////////////////////////////TEST////////////////////////////" << endl;
